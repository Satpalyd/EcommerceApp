  ...
  return <div className="mt-14 mb-12">
    <div className="container">
     <div className="text-center mb-10 max-w-[600px] mx-auto">
       ...
       <p data-aos="fade-aos" className="text-xs text-gray-400">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus voluptatum porro vel optio blanditiis veritatis ipsam, a in omnis minus.
       </p>
     </div>
     <div>
